    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-muted-foreground">Registro y control de gastos</p>
        </div>
      ...
      <div className="flex flex-col items-center justify-center rounded-xl border border-white/20 bg-white/60 py-24 backdrop-blur-lg dark:border-white/10 dark:bg-white/5">
        ...
        <h3 className="mt-4 text-lg font-semibold">Sin gastos</h3>
        <p className="mt-1 max-w-sm text-center text-sm text-muted-foreground">
          Registrá los gastos de tus consorcios para incluirlos en las liquidaciones mensuales.
        </p>
